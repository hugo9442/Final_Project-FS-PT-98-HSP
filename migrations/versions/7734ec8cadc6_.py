...
Revision ID: 7734ec8cadc6
Revises: 
Create Date: 2025-06-30 15:25:43.126884
...
def upgrade():
    ...
    sa.Column('renta', sa.Float(), nullable=False),
    ...
    sa.Column('bill_amount', sa.Integer(), nullable=True),
