...
import { faHouseChimney, faChartLine, faWrench, faUserCheck, faFileContract, faTriangleExclamation, faStar } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className="container">
                    <blockquote className="blockquote">
                       ...
                       <i class="fa-solid fa-star" style={{color:"#FFD700"}}></i>
                        ...
                        <footer className="blockquote-footer">Montoria, Sl.</footer>
                    </blockquote>
                </div>
            </section>
