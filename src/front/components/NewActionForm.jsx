...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const res = await fetch(`https://miniature-sniffle-7vpgxp6x9g5vfwx97-3001.app.github.dev/actions/create`, {
      method: "POST",
      headers: {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-3 border rounded bg-white mt-2">
      <div className="row">
        ...
        <div className="col-md-6">
          <input name="status" placeholder="Estado" className="form-control mb-2" onChange={handleChange} required />
