...
const Url =`${Urlexport}/contracts`;



export const contracts = {
  create_contract: async (start_date, end_date,contract,id, token) => {

     if (!contract || !contract.name.toLowerCase().endsWith(".pdf")) {
    ...
    formData.append("document", contract);
