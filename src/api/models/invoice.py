...
class Invoice(db.Model):
    ...
    iva_percent: Mapped[float] = mapped_column(Numeric(5,2), nullable=False, default=0.0)
    withholding_percent: Mapped[float] = mapped_column(Numeric(5,2), nullable=False, default=0.0)
    ...
    def serialize(self):
        return {
            ...
            "iva_percent": float(self.iva_percent) if self.iva_percent else 0.0,
            "withholding_percent": float(self.withholding_percent) if self.withholding_percent else 0.0,
