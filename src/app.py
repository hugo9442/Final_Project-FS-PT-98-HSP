...
from api.routes import apartments_api, users_api, contracts_api, issues_api, actions_api, asociates_api, documents_api, invoices_api, contact_api, dashboard_api
